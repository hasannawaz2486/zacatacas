    ...
    <div className="row d-flex justify-content-center" style={{ margin: "50px 10px" }}>
      <div className="col-lg-10 col-md-6 d-flex flex-column align-items-center justify-content-center">
        <div className="col-lg-5 col-md-12 col-sm-6">
          <h3 style={{ fontWeight: "bold", color: "#000", textAlign: "center" }}>{heading}</h3>
        </div>

        <p style={{ fontWeight: "500", fontSize: "14px", color: "#000", textAlign: "center" }}>{description}</p>
      </div>
