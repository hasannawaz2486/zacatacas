      ...
      >
        ...
        <div className="col-lg-4 col-md-12 py-5" style={{ color: "black" }}>
          ...
          <div className="mt-3 " style={{
            ...
            <div className="d-flex p-2 ml-1"  style={{
            ...
            <div className="d-flex p-2 ml-1 mt-2"  style={{
              border: "2px solid #EAEAEA",
              borderRadius: "10px",    
            }}> 
                <img src={CardImage1} alt="Card Image 1" />
            ...
            <div className="d-flex justify-content-center align-items-center mt-5"> See more</div>
