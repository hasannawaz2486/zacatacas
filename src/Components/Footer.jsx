        ...
        <div className="row" style={{ width: "100%" }}>
          <div className="col-lg-3 col-md-6 col-sm-6">
            ...
            >
              ...
              <Link to="https://x.com/sezac_" style={iconStyle}>
                <FaTwitter />
              </Link>
              <div style={iconStyle}>
                <FaLinkedinIn />
              </div>
              <Link to="https://www.instagram.com/se_zac/" style={iconStyle}>
                <FaInstagram />
              </Link>
              <Link
          ...
          <div className="col-lg-3 col-md-6 col-sm-6">
            ...
            <div style={phoneContainerStyle}>
              <a href="tel:9223005" className="d-flex align-items-center" style={{"textDecoration": "none"}}>
            ...
            <div style={phoneContainerStyle}>
            <a href="tel:9225350" className="d-flex align-items-center" style={{"textDecoration": "none"}}>
                <FaPhone style={iconStyle1} />
                <span style={phoneTextStyle}>
            ...
            <div style={phoneContainerStyle}>
              ...
              <a href="tel:9220180" className="d-flex align-items-center" style={{"textDecoration": "none"}}>
                <FaPhone style={iconStyle1} />
                <span style={phoneTextStyle}>
            ...
            <div style={phoneContainerStyle}>
              ...
              <a href="tel:9245320" className="d-flex align-items-center" style={{"textDecoration": "none"}}>
                <FaPhone style={iconStyle1} />
                <span style={phoneTextStyle}>
            ...
            <div style={phoneContainerStyle}>
              ...
              <a href="tel:4915000" className="d-flex align-items-center" style={{"textDecoration": "none"}}>
                <FaPhone style={iconStyle1} />
                <span style={phoneTextStyle}>
            ...
            <div style={phoneContainerStyle}>
              ...
              <a href="tel:911" className="d-flex align-items-center" style={{"textDecoration": "none"}}>
                <FaPhone style={iconStyle1} />
                <span style={phoneTextStyle}>
            ...
            <div style={phoneContainerStyle}>
              ...
              <a href="tel:089" className="d-flex align-items-center" style={{"textDecoration": "none"}}>
                <FaPhone style={iconStyle1} />
                <span style={phoneTextStyle}>
          ...
          <div className="col-lg-3 col-md-6 col-sm-6">
            ...
            <div style={phoneContainerStyle}>
              <FaMapMarkerAlt style={iconStyle1} />
              <a
